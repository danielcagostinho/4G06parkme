...
//  int distance4 = sensor4.read(CM);
  ...
  if (loopdist == true){
    ...
    Serial.println("5c4946c9ac8f790000f001cf, 0"); // Sensor 1
    Serial.println("5c4be566bc01840000b851d3, 0"); // Sensor 2
    Serial.println("5c534fd3a2b1de00000ed7a3, 1"); // Sensor 3
    Serial.println("5c53504ea2b1de00000ed7a4, 1"); // Sensor 4
    loopdist = true;
  }
